...
const isRenewable = (order) => {
  if (!order || !order.items) return false;
  // An order can be renewed if it's paid and has a purchase that is not active.
  // This is a simple logic, might need adjustment based on more specific business rules.
