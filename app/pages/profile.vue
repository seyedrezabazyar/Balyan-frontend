          ...
          <div v-if="!hasPassword" class="mb-6">
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
              <div class="flex">
                ...
                <div class="mr-3">
                  <h3 class="text-sm font-medium text-yellow-800">حساب شما رمز عبور ندارد</h3>
                  <p class="text-sm text-yellow-700 mt-1">می‌توانید یک رمز عبور تنظیم کنید.</p>
                </div>
              </div>
            </div>
            <button
          ...
          <div v-else class="mb-6">
            <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
              <div class="flex">
                ...
                <div class="mr-3">
                  <h3 class="text-sm font-medium text-green-800">حساب شما دارای رمز عبور است</h3>
